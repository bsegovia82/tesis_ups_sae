...
public class BeanMantenedorNotasMaterias extends
	...
	public void cargarDocentes (AjaxBehaviorEvent lEvento) {
		...
		String lQuery = "select * from sae_notas_estudiantes s " + "where s.ID_MATERIA_CURSO_ANIO = :idMateria "
		...
		for (SaeNotasEstudiante nota : lListaNotasEstudiantes) {
			...
			if (!lNotasDB.isEmpty()) 
			{
				...
				nota.setlNotaPG1(lNotasDB.get(0).getlNotaPG1());
				nota.setlNotaPG2(lNotasDB.get(0).getlNotaPG2());
				nota.setlNotaPG3(lNotasDB.get(0).getlNotaPG3());
				nota.setlNotaPG4(lNotasDB.get(0).getlNotaPG4());
				
				nota.setlNotaPT1(lNotasDB.get(0).getlNotaPT1());
				nota.setlNotaPT2(lNotasDB.get(0).getlNotaPT2());
				nota.setlNotaPT3(lNotasDB.get(0).getlNotaPT3());
				nota.setlNotaPT4(lNotasDB.get(0).getlNotaPT4());
				
				nota.setlNotaPL1(lNotasDB.get(0).getlNotaPL1());
				nota.setlNotaPL2(lNotasDB.get(0).getlNotaPL2());
				nota.setlNotaPL3(lNotasDB.get(0).getlNotaPL3());
				nota.setlNotaPL4(lNotasDB.get(0).getlNotaPL4());
				
				nota.setlNotaPI1(lNotasDB.get(0).getlNotaPT1());
				nota.setlNotaPI2(lNotasDB.get(0).getlNotaPT2());
				nota.setlNotaPI3(lNotasDB.get(0).getlNotaPT3());
				nota.setlNotaPI4(lNotasDB.get(0).getlNotaPT4());
	...
	public void registrarNota(AjaxBehaviorEvent lEvento) {
		...
		try {
			...
			lNota = servicioMantenedor.obtenerObjtoPK(idNota, SaeNotasEstudiante.class);
