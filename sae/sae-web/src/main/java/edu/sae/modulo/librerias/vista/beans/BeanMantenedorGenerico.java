package edu.sae.modulo.librerias.vista.beans;
...
import edu.sae.modulo.librerias.eao.GenericEAO;
...
import edu.sae.modulo.librerias.servicio.ServicioMantenimientoEntidad;
import edu.sae.modulo.librerias.vista.JsfUtil;
import edu.sae.modulo.librerias.vista.beans.oyentes.ControlDialogo;
...
import edu.sae.modulo.librerias.vista.beans.oyentes.PostErrorTransaccionListener;
...
import edu.sae.modulo.librerias.vista.beans.oyentes.ValidadorIngresoDatosListener;
import edu.sae.modulo.librerias.vista.exceptions.ErrorAccionesPreTransaccion;
import edu.sae.modulo.librerias.vista.exceptions.ErrorNoAutenticacion;
...
public abstract class BeanMantenedorGenerico<SERVICIO extends ServicioMantenimientoEntidad<EAO, ENTIDAD, Id>, Id extends Serializable, ENTIDAD extends EntidadBaseAuditable<Id>, EAO extends GenericEAO<ENTIDAD, Id>>
	...
	protected void cierreDialogo(String pNombreDialogo) {
		RequestContext context = RequestContext.getCurrentInstance();
		context.execute("PF('" + pNombreDialogo + "').hide();");
	}
	...
	public void setNombreAtributoCambioEstado(String nombreAtributoCambioEstado) {
		this.nombreAtributoCambioEstado = nombreAtributoCambioEstado;
	}
