...
import edu.sae.modulo.servicio.mantenimiento.aplicacion.ServicioMantenedorOpcion;
...
public class BeanMantenedorOpciones
	...
	protected void cargarListaEtiquetas() {  
		...
		this.listaEtiquetasPantalla.put(NombresEtiquetas.AYUDAPAGINA.toString(), "Cree o edite las Opciones");
