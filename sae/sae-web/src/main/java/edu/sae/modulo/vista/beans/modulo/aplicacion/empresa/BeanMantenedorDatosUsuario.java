package edu.sae.modulo.vista.beans.modulo.aplicacion.empresa;
...
@ManagedBean
@ViewScoped
public class BeanMantenedorDatosUsuario
	 ...
	 */
	public BeanMantenedorDatosUsuario() {
		...
		addPostConstructuListener(new PostConstructListener() {
			...
			public void metodoPostConstruct() {
				...
				String lQuery = "select * from onix_empresa_cliente where id in ( "
						+ "select b.id_empresa from onix_usuarios a, onix_usuario_empresa_cliente b "
		...
		addControlListaEntidadesPersonalizada(new ControlListaEntidadesPersonalizada() {
			...
			public void cargarListaEntidades() {
				...
				lParametros.put("usuario", JsfUtil.getUsuarioAutenticado().getName());
				String lQuery = "select * from onix_usuarios where id in "
						+ "(select id_usuario from onix_usuario_empresa_cliente where id_empresa  in ( "
						+ "						select b.id_empresa from onix_usuarios a, onix_usuario_empresa_cliente b "
						+ "						where a.usuario = :usuario "
						+ "						and a.estado = 'A'  "
						+ "						and b.id_usuario = a.id  "
						+ "						and b.estado = 'A') and estado = 'A') and usuario != 'ADMIN'";

				setListaEntidades(servicioMantenedor.ejecutarQueryNativoObjeto(lQuery, lParametros, OmsUsuario.class));
	...
	private void cargatListaRoles(OmsUsuario pEntidadSeleccionada) {
		...
		List<String> listaOpcionesPorAsignar = servicioMantenedor.obtenerRolesPorAsignarEmpresa(usuarioAutenticado(),
				pEntidadSeleccionada.getId());
	 ...
	 *
	 * @param rolesSeleccionadas
	 *            the new roles seleccionadas
	 */
	 ...
	 *
	 * @param listaSeleccionRol
	 *            the new lista seleccion rol
	 */
	 ...
	 *
	 * @param lContraseniaNueva
	 *            the new l contrasenia nueva
	 */
