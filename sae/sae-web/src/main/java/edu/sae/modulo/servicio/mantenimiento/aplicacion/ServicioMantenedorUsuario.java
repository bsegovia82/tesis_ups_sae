...
import edu.sae.modulo.librerias.servicio.oyentes.AccionValidacionSimpleListener;
...
public class ServicioMantenedorUsuario extends ServicioMantenedorControlAuditoria<OmsUsuarioEAO, OmsUsuario, Long> {
	...
	public List<OmsRole> listaRolesEmpresa() {
		...
		String lQuery = "select b.* from ONIX_ROLES b where b.ambito = 'E' and estado = 'A' and seleccionable = 'S' ";
